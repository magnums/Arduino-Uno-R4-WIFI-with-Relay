#include "ArduinoGraphics.h"    // 🟢 ต้องมาก่อน!
...
void loop() {
  handleClient();
  showTextAnimation();  // 🧠 Update text animation each loop
}

// 🔁 ฟังก์ชันแสดงข้อความ Animation ตาม output
